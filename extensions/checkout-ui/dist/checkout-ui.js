(() => {
  ...
  function useRender() {
    const render4 = (0, import_react3.useContext)(RenderContext);
    if (render4 == null) {
  ...
  function createComponentWrapper(componentType, fragmentProps) {
    const Component3 = componentType;
    return /* @__PURE__ */ (0, import_react4.memo)(function ComponentWrapper(_a) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Component3, __spreadProps(__spreadValues({}, props), {
        children
      }));
    });
  }
  ...
  function reactExtension(target, render4) {
    return extension(target, (root, api) => __async(this, null, function* () {
      const element = yield render4(api);
...
${errorInfo.componentStack}`);
  ...
  // extensions/checkout-ui/src/GachaDraw.jsx
  var import_react14 = __toESM(require_react());
  var import_jsx_runtime4 = __toESM(require_jsx_runtime());
  var GachaDraw_default = reactExtension(
    "purchase.checkout.block.render",
    () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(GachaDraw, {})
  );
  function isGachaEligible(metafield) {
    return metafield !== void 0 && parseInt(metafield.metafield.value) === 1;
  }
  function drawGacha(applyMetafieldChange, setGachaDrawn, setLoading) {
    return __async(this, null, function* () {
      setLoading(true);
      const gachaResult = Math.round(Math.random());
      console.log(`gacha result: ${gachaResult}`);
      console.log("applying metafield...");
      const result = yield applyMetafieldChange({
  ...
  function GachaDraw() {
    const [gachaDrawn, setGachaDrawn] = (0, import_react14.useState)(false);
    ...
    const gachaEligibility = appMetafields.current.find((metafield) => {
      return metafield.metafield.namespace === "custom" && metafield.metafield.key === "gacha_eligibility";
    });
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { border: "base", borderWidth: "base", cornerRadius: "base", padding: "base", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { children: "You are selected!" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { appearance: "subdued", children: "Win a lottery to earn a discount for next purchase." }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { children: !gachaDrawn ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        Button2,
        {
          kind: "secondary",
          loading,
      ...
      ) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: "See the result after checkout!" }) })
    ] });
  }

  // node_modules/@shopify/ui-extensions/build/esm/surfaces/customer-account/extension.mjs
  var extension2 = createExtensionRegistrationFunction();
  ...
  var ExtensionApiContext2 = /* @__PURE__ */ (0, import_react15.createContext)(null);

  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/customer-account/render.mjs
  var import_jsx_runtime5 = __toESM(require_jsx_runtime(), 1);
  function reactExtension2(target, render4) {
    return extension2(target, (root, api) => __async(this, null, function* () {
      const element = yield render4(api);
      yield new Promise((resolve, reject) => {
        try {
          render(/* @__PURE__ */ (0, import_jsx_runtime5.jsx)(ExtensionApiContext2.Provider, {
            value: api,
            children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(ErrorBoundary2, {
              children: element
            })
          }), root, () => {
            resolve();
  ...
  var ErrorBoundary2 = class extends import_react16.Component {
    constructor(...args) {
      super(...args);
      this.state = {
        hasError: false
...
${errorInfo.componentStack}`);
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/customer-account/hooks/api.mjs
  function useApi2() {
    const api = (0, import_react18.useContext)(ExtensionApiContext2);
    if (api == null) {
  ...
  // extensions/checkout-ui/src/GachaResult.jsx
  var import_jsx_runtime6 = __toESM(require_jsx_runtime());
  var GachaResult_default = reactExtension2(
    "purchase.thank-you.block.render",
    () => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(GachaResult, {})
  );
  function GachaResult() {
    const { metafields } = useApi2();
    console.log("thank you: going through metafields");
    for (const metafield of metafields.current) {
      console.log(`key: ${metafield.key}=${metafield.value}`);
    }
    const gachaDiscount = metafields.current.find((metafield) => {
      return metafield.namespace === "custom" && metafield.key === "gacha_discount";
    });
    console.log("thank you: gacha discount:");
    console.log(gachaDiscount);
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(BlockStack2, { border: "base", borderWidth: "base", cornerRadius: "base", padding: "base", children: gachaDiscount.value === 1 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Heading2, { level: "3", children: "You got discount for your next purchase!" }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Heading2, { level: "3", children: "Sorry, no discount this time :(" }) });
  }
})();
